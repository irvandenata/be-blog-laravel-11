...
const SearchArticlePage = () => {
  ...
  const blogsStructuredData = {
    ...
    "@type": "CollectionPage",
    name: `${t("blog.seoTitle")} | Irvan Denata`,
        ...
        <div className="flex w-full my-8">
          ...
          >
            ...
            <div className="flex justify-center mt-6">
              ...
              >
                <option value="0">{t("blog.allCategory")}</option>
                {articleCategory.map((item: any, index: number) => (
                  <option
                    key={index + "-category"}
                    value={item.id}
      ...
      <div className="content relative z-10 mb-30" id="article-content">
        <div className="mx-auto w-full">
          ...
          {articles.length <= 0 &&
            ...
            !isLoad && (
              <div className="flex justify-center">
                <p className="text-lg font-bold">{t("blog.notFound")}</p>
              </div>
            )}
